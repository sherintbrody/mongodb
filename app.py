...
# --- ANALYTICS PAGE (ONLY CHART FIXES APPLIED) ---
elif page == "Analytics":
        ...
        if not closed_df.empty and 'pnl' in closed_df.columns:
            ...
            if not trades_with_pnl.empty:
                ...
                with tab1:
                    ...
                    # INSTRUMENT-BASED P&L ANALYSIS (HORIZONTAL CHARTS)
                    if 'symbol' in trades_with_pnl.columns:
                        ...
                        instrument_pnl = instrument_pnl.sort_values('Total P&L', ascending=True)
                        ...
                        with col1:
                            ...
                            # Top 10 instruments
                            top_instruments = instrument_pnl.tail(10)
                            ...
                            fig.add_trace(go.Bar(
                                y=top_instruments['Symbol'],
                                x=top_instruments['Total P&L'],
                                orientation='h',
                                marker_color=colors,
                            ...
                            layout = get_chart_layout()
                            layout['yaxis_title'] = "Instrument"
                            layout['xaxis_title'] = "Total P&L ($)"
                            layout['height'] = max(400, len(top_instruments) * 40)
                            layout['showlegend'] = False
                            fig.update_layout(**layout)
                        ...
                        with col2:
                            ...
                            winrate_df = winrate_df[winrate_df['Trades'] >= 3]
                            winrate_df = winrate_df.sort_values('Win Rate', ascending=True).tail(10)
                            ...
                            if not winrate_df.empty:
                                ...
                                layout['height'] = max(400, len(winrate_df) * 40)
                                layout['showlegend'] = False
                                fig.update_layout(**layout)
